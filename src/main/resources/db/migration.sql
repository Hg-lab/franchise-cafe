...
-- 샷 선택 옵션
INSERT INTO product_option_item (id, product_option_id, name, display_name, add_price, is_default)
VALUES
    (1, 2, 'SINGLE_SHOT', '싱글 샷', 0, 1),
    (2, 2, 'DOUBLE_SHOT', '더블 샷', 500, 0),
    (3, 2, 'TRIPLE_SHOT', '트리플 샷', 1000, 0),
-- 당도 선택 옵션
    (4, 3, 'LESS_SWEET', '당도 적게', 0, 1),
    (5, 3, 'REGULAR_SWEET', '일반 당도', 0, 0),
    (6, 3, 'EXTRA_SWEET', '당도 추가', 200, 0),
-- 토핑 선택 옵션
    (7, 4, 'CARAMEL_SYRUP', '카라멜 시럽', 300, 0),
    (8, 4, 'CHOCOLATE_SYRUP', '초콜릿 시럽', 300, 0),
    (9, 4, 'VANILLA_SYRUP', '바닐라 시럽', 300, 0),
    (10, 4, 'ESPRESSO_POWDER', '에스프레소 파우더', 200, 0),
    (11, 4, 'CINNAMON_POWDER', '시나몬 파우더', 100, 0),
-- 휘핑 추가 옵션
    (12, 5, 'WHIPPED_CREAM', '휘핑 추가', 300, 0),
-- 건강 옵션 선택
    (13, 7, 'ALMOND_MILK', '아몬드 밀크', 500, 0),
    (14, 7, 'SOY_MILK', '두유', 500, 0),
    (15, 7, 'OAT_MILK', '귀리 우유', 500, 0),
-- 꿀 추가 옵션
    (16, 8, 'HONEY', '꿀 추가', 400, 0),
-- 디카페인 샷 추가 옵션
    (17, 9, 'DECAF_SHOT', '디카페인 샷', 500, 0),
-- 시나몬 추가 옵션
    (18, 6, 'ADD_CINNAMON', '시나몬 추가', 200, 0);
